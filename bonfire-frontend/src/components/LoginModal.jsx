                        ...
                        >
                            ...
                            <div style={{ flex: 1 }}>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                                    <span style={{ fontWeight: 'bold', color: 'var(--text-primary)' }}>{u.display_name || u.username}</span>
                                    {(u.username === 'willalo' || u.username === 'im_jannox') && (
                                        <span style={{
                                            ...
                                            color: 'var(--accent-primary)', fontSize: '0.6rem',
