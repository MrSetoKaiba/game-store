    ...
    <div className="animate-fadeIn">
      <div className="page-header">
        ...
        <div className="page-header__actions">
          {isAdmin && <button className="btn btn--primary" onClick={openCreate}>+ Neuer User</button>}
        </div>
      </div>
      ...
      <div className="users-grid stagger">
        {users.map(user => (
          <div key={user.id} className="user-card">
            <div className="user-card__avatar" style={{ overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              {user.avatar_url ? (
            ...
            <p style={{ fontSize: '0.8rem', color: 'var(--text-dim)', marginBottom: '1rem' }}>{user.email}</p>
            ...
            {isAdmin && (
              <div className="card-actions">
                ...
                <button className="btn btn--ghost btn--sm" onClick={() => handleDelete(user)}>Löschen</button>
              </div>
            )}
          </div>
        ))}
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-row">
            <div className="form-group">
              ...
              <input value={form.username} onChange={e => setForm({ ...form, username: e.target.value })} placeholder="z.B. willalo" />
            </div>
            <div className="form-group">
