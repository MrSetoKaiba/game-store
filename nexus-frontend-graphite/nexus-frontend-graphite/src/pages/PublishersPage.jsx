    ...
    <div className="animate-fadeIn">
      <div className="page-header">
        ...
        <div className="page-header__actions">
          <button className="btn btn--primary" onClick={openCreate}>+ Neuer Publisher</button>
        </div>
      </div>
        ...
        {publishers.map(pub => (
          <div key={pub.id} className="publisher-card">
            ...
            <div className="card-actions">
              ...
              <button className="btn btn--danger btn--sm" onClick={() => handleDelete(pub)}>Löschen</button>
            </div>
          </div>
        ))}
      </div>
